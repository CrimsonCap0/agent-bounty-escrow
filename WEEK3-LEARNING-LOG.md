...
- 完成 300–500 字的 [Week 3 团队角色说明](WEEK3-TEAM-ROLE.md)，明确能承担的工作、需要的队友和已有 Proof of Work。
...
### Prompt 04：Week 3 团队角色说明

```text
用 300–500 字说明进入 Week 3 团队后能承担什么角色、需要什么队友、能提供什么 Proof of Work。
```

**用途：** 让潜在队友快速判断我的能力、协作需求和现有产出。<br>
**结果：** 角色确定为 DApp 开发 / 原型负责人，需要 Research、Ops 及合约安全方向的协作者。<br>
**人工判断：** Proof of Work 同时写出公开产出和当前错误，不把未完成的双钱包流程包装成已经交付。
